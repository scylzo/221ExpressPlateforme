...
function auxin_modern_comment_form( $comment_form, $params ){
    ...
    $replay_title  = auxin_get_option( 'comment_forms_replay_title', __( 'Add a Comment', 'phlox' ) );
    ...
    $comment_form['title_reply']          = '<span>' .$replay_title . '</span>';
