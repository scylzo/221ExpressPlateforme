...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $sections[] = array(
        ...
        'parent'      => 'appearance-section', // section parent's id
        'title'       => __( 'Typography (deprecated)', 'phlox' ),
    ...
    $options[] = array(
        ...
        'description' => __( 'Specifies replay title of comment forms.', 'phlox' ),
    ...
    $options[] = array(
        'title'          => __( 'Replay Title Typography', 'phlox' ),
        'description'    => '',
...
/* ---------------------------------------------------------------------------------------------------
   ...
   $options[] = array(
    ...
    $options[] = array(
        ...
        'description' => __( 'Enable it to replace single section with an Elementor template.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'post_js'   => '$( "body.single" ).removeClass( "aux-nd aux-hd aux-xhd aux-s-fhd aux-fhd" ).addClass( "aux-" + to ); $(window).trigger("resize");',
        'default'   => ''
    );
    ...
    //     'description' => __( 'Enable it to replace archive section with an Elementor template.', 'phlox' ),
    ...
    $options[] = array(
        ...
        'post_js'   => '$( "body.archive" ).removeClass( "aux-nd aux-hd aux-xhd aux-s-fhd aux-fhd" ).addClass( "aux-" + to ); $(window).trigger("resize");',
        'default'   => ''
    );
    ...
    $options[] = array(
        ...
        'post_js'   => '$( "body.page" ).removeClass( "aux-nd aux-hd aux-xhd aux-s-fhd aux-fhd" ).addClass( "aux-" + to ); $(window).trigger("resize");',
        'default'   => ''
    );
